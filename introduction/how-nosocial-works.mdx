...
NoSocial is a complete re-design of how matching systems work. Unlike a point-in-time evaluation of a CV and Job Description. Our AI enabled system is continously matching based on feedback on interactions between candidates and employers making static CV's and Job Descriptions obsolete. 

Matches are brokered by the AI system that mediates the connection while respecting data privacy and data sharing. The result of this approach is both sides of the market (supply and demand) will have the best possible match outcomes available to them. 

## Key Principles

<CardGroup cols={2}>
  <Card title="Continous Matching" icon="arrow-right-arrow-left" iconType="regular" color="#82e985" href="continous-matching.mdx">
    Every candidate and job is evaluated continously  as feedback is incorporated by users into their AI instructions.
  </Card>
