...
3. **Receive Market Insights:** NoSocial will generate your initial[ market benchmark](https://docs.nosocial.ai/how-it-works/market-insights) report within 24 hours .
3. **Receive Matches:** The system continuously finds opportunities that fit your criteria. See [Two sided matches](/how-it-works/core-concepts) for how our matching process and timelines work.
