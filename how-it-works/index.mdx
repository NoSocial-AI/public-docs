...
<CardGroup cols={2}>
  <Card title="Core Concepts" icon="brain" iconType="solid" color="#82e985" href="/how-it-works/core-concepts">
    Learn about Continuous Matching, Two-Sided Evaluation, and Context & Intent.
  </Card>
  <Card title="For Candidates" icon="user" iconType="solid" color="#82e985" href="/how-it-works/candidates">
    How matching, privacy, and instructions work for candidates.
  </Card>
  <Card title="For Employers" icon="building" iconType="solid" color="#82e985" href="/how-it-works/employers">
    Creating postings, AI evaluations, and managing matches.
  </Card>
</CardGroup>
